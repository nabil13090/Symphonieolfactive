        ...
        <tbody>
          <?php foreach ($parfum as $value) { ?>
            <tr>
              ...
              <td>
                <a class="btn btn-outline-danger mt-auto" href="supprimé.php?id=<?= $value['id'] ?>" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce produits ?');"><i class="bi bi-x-circle text-danger "></i> SUPPRIMER</a>
              </td>
            </tr>
          <?php }  ?>
        </tbody>
